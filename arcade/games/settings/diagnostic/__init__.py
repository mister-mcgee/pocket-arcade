...
class Diagnostic(Scene):
  def __init__(self):
    ...
    self.l_up_sprite = Image.load("/arcade/games/settings/diagnostic/l_up.bmp")
    self.l_dn_sprite = Image.load("/arcade/games/settings/diagnostic/l_dn.bmp")
    self.r_up_sprite = Image.load("/arcade/games/settings/diagnostic/r_up.bmp")
    self.r_dn_sprite = Image.load("/arcade/games/settings/diagnostic/r_dn.bmp")
    self.a_up_sprite = Image.load("/arcade/games/settings/diagnostic/a_up.bmp")
    self.a_dn_sprite = Image.load("/arcade/games/settings/diagnostic/a_dn.bmp")
    self.b_up_sprite = Image.load("/arcade/games/settings/diagnostic/b_up.bmp")
    self.b_dn_sprite = Image.load("/arcade/games/settings/diagnostic/b_dn.bmp")
